...
* Item system with many item types including: tile items, transmutable items, conduit items, and more.
...
* Tile entity system to add behavior to tiles placed in the world such as chests, torches, machines, and many more.
...
* Questbook that guides players through the game and rewards them for completing quests. Includes item retrieval, visit dimension and checkbox quests.
* Many developer tool scripts and a in game dev tools for editing questbooks, and building in game structures.
