...
namespace WaveFunctionCollaps
{
    public class ValuesManager<T>
    {
        ...
        //{
        //    int yMax = _grid.Length - 1;
        //    int xMax = _grid[0].Length - 1;
        //    if (x < 0 && y < 0)
        //    {
        //        return GetGridValue(xMax, yMax);
        //    }
        //    if (x < 0 && y > yMax)
        //    {
        //        return GetGridValue(xMax, 0);
        //    }
        //    if (x > xMax && y < 0)
        //    {
        //        return GetGridValue(0, yMax);
        //    }
        //    if (x > xMax && y > yMax)
        //    {
        //        return GetGridValue(0, 0);
        //    }
        //    if (x < 0)
        //    {
        //        return GetGridValue(xMax, y);
        //    }
        //    if (x > xMax)
        //    {
        //        return GetGridValue(0, y);
        //    }
        //    if (y > yMax)
        //    {
        //        return GetGridValue(x, 0);
        //    }
        //    if (y < 0)
        //    {
        //        return GetGridValue(x, yMax);
        //    }
